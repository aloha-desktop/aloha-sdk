...
[![github action](https://github.com/aloha-desktop/aloha-sdk/actions/workflows/npm-publish.yml/badge.svg)](https://github.com/aloha-desktop/aloha-sdk/actions/workflows/npm-publish.yml)

## Plugins with dependencies

To bundle dependencies with your plugin we recommend using a bundler. 

To get started quickly use the official [vite-aloha template](https://github.com/aloha-desktop/vite-aloha)
